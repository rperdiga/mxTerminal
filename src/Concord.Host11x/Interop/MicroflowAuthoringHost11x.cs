...
/// <summary>
/// Implements IMicroflowAuthoringHost against the 11.6.2 ExtensionsAPI surface.
...
/// </summary>
public sealed class MicroflowAuthoringHost11x : IMicroflowAuthoringHost
{
    ...
    public MicroflowAuthoringHost11x(
        IModel model,
    ...
    public DocumentId Create(CreateMicroflowRequest request)
    {
        ...
        // Note: IMicroflow.Documentation is not exposed in the 11.6.2 ExtensionsAPI surface.
    ...
    public void DeleteActivity(string microflowQualifiedName, int activityPosition)
    {
        ...
        // IActionActivity.Delete() is not exposed in the 11.6.2 ExtensionsAPI surface.
        // Activity deletion requires the untyped model API. Throw to signal unsupported.
        throw new NotSupportedException(
            "DeleteActivity is not supported via the 11.6.2 typed ExtensionsAPI surface. " +
    ...
    {
        // IMicroflow in 11.6.2 does not expose an AllowedModuleRoles setter or AllMicroflowAccess
    ...
    private MicroflowSummary BuildSummary(IMicroflow mf, string moduleName)
    {
        ...
        return new MicroflowSummary(
            ...
            Module: moduleName,
            Name: mf.Name,
            Documentation: null, // IMicroflow.Documentation not exposed in 11.6.2 ExtensionsAPI
            AccessLevel: MicroflowAccessLevel.CheckPerOperation, // read-back not exposed in 11.6.2 typed API
