...
/// <summary>
/// Implements INavigationHost against the 11.6.2 ExtensionsAPI surface.
...
///
/// INavigationManagerService in 11.6.2 exposes only PopulateWebNavigationWith.
...
/// </summary>
public sealed class NavigationHost11x : INavigationHost
{
    private readonly IModel _model;
    private readonly INavigationManagerService _nav;

    public NavigationHost11x(
        IModel model,
    ...
    /// <summary>
    /// Returns navigation profile stubs. The 11.6.2 ExtensionsAPI surface exposes
    ...
    /// <summary>
    /// Returns null — the 11.6.2 ExtensionsAPI does not expose a read-back API
    ...
    /// <summary>
    /// Remove is not supported via INavigationManagerService in 11.6.2.
    ...
    /// <summary>
    /// Icon setting is not exposed by INavigationManagerService in 11.6.2. No-op.
    /// </summary>
