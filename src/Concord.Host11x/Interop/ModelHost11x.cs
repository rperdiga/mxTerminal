...
/// <summary>
/// Implements IModelHost against the 11.6.2 ExtensionsAPI surface.
/// </summary>
public sealed class ModelHost11x : IModelHost
{
    ...
    public ProjectInfo GetProjectInfo()
    {
        ...
        return new ProjectInfo(
            ...
            // IProject in 11.6.2 does not expose ServerVersion or AppId.
            MendixVersion: null,
            AppId: null);
    }
    ...
    public IReadOnlyList<ConfigurationSetting> ReadConfigurations()
    {
        ...
        return configSettings.GetConfigurations()
            .Select(c => new ConfigurationSetting(
                Name: c.Name,
                // IsActive and database fields are not exposed on IConfiguration in 11.6.2.
                IsActive: false,
                DatabaseType: null,
    ...
    {
        // IConfigurationSettings in 11.6.2 has no method to mark a configuration active;
