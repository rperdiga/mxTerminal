...
/// <summary>
/// Implements IUntypedModelHost against the 11.6.2 ExtensionsAPI surface.
...
/// on both 10.21.1 and 11.6.2. The service is resolved via optional constructor
/// injection; IsAvailable reflects whether the injected instance is non-null.
/// </summary>
public sealed class UntypedModelHost11x : IUntypedModelHost
{
    private readonly IModel _model;
    private readonly IUntypedModelAccessService? _untyped;

    public UntypedModelHost11x(
        IModel model,
